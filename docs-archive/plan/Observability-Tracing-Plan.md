# Observability & Tracing (OTel + LangSmith)
...
**🟦 AGENT:**
- All agent-run logs correlate by trace id, and prompt-to-tool-to-UI cycle always follows same ID chain.
...
- Unit/integration tests must check that trace/context/log fields are present and correct for:
  - Normal agent steps
  - Error cases
  - Interrupts/approval cycles

**🟨 HUMAN:**
- Regularly check monitoring dashboards/trace trees, esp. after prompt/graph/infra updates.
...
- [tracing-approach.md](../../initial-setup/tracing-approach.md)
- [LangGraph-Orchestration-Plan.md](LangGraph-Orchestration-Plan.md)
- [Chat-Transport-API-Plan.md](Chat-Transport-API-Plan.md)
- [Tool-Layer-Plan.md](Tool-Layer-Plan.md)

---

## ✅ Section 9 Complete: Observability & Tracing (OTel + LangSmith)
